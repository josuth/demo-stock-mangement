...
public class GlobalTestingHelper {
	...
	public static List<Price> buildListPricesEntity() {
		return List.of(
	...
	public static List<Price> buildListCnflictPricesEntity() {
		return List.of(
				// Product 3 (2 fares, equal priority), overlap in time, will be used for conflicts
				Price.builder()
					.priceId(BigInteger.valueOf(2L))
					.brandId(1)
					.productId(3L)
